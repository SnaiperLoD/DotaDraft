...
### Ручная разметка способностей (`ability-tagging.csv`) — питает `mobility`, `saving`, `initiating`, `control_strength`

Отдельная система от Ability Tiers выше — размечается не герой целиком, а каждая способность по отдельности (789 способностей, 127 героев), по 4 категориям (0–10 за способность, пусто = не относится):
